(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@aspnet/signalr'), require('jquery'), require('jquery-ui/ui/widgets/draggable'), require('jquery-ui/ui/widgets/droppable'), require('jquery-mousewheel')) :
    typeof define === 'function' && define.amd ? define('ngx-modelstage', ['exports', '@aspnet/signalr', 'jquery', 'jquery-ui/ui/widgets/draggable', 'jquery-ui/ui/widgets/droppable', 'jquery-mousewheel'], factory) :
    (factory((global['ngx-modelstage'] = {}),global.signalr,global.JQuery));
}(this, (function (exports,signalr,JQuery) { 'use strict';
    ...
    })(exports.psgeometry || (exports.psgeometry = {}));
    ...
    ***************************************************************************** */
    ...
    (function (modelstageweb) {
        ...
        var BlockStreamReader = /** @class */ (function () {
             ...
             */
                function () {
                    /** @type {?} */
                    var result = new exports.psgeometry.Matrix4();
        ...
        var AssetFactoryWebGL = /** @class */ (function () {
             ...
             */
                function (reader, stage, assetStore, deferreds) {
                    ...
                    if (reader.tryReadString(function (value) { textureName = value; }) && reader.tryReadInt64(function (value) { pixelDataSize = value; })) {
                        ...
                        /** @type {?} */
                        var deferred_1 = JQuery__default.Deferred();
             ...
             */
                function (buffer) {
                    ...
                    return JQuery__default.when.apply(JQuery__default, deferreds);
                };
            /**
             * @param {?} url
             * @return {?}
             ...
             */
                function (url) {
                    var _this = this;
                    /** @type {?} */
                    var deferred = JQuery__default.Deferred();
                    /** @type {?} */
        ...
        var Octree = /** @class */ (function () {
            function Octree() {
                this.boundingBox = new exports.psgeometry.AABB3D();
            }
            /**
             * @param {?} reader
             * @return {?}
             ...
             */
                function () {
                    if (this.intersector) {
                        ...
                        return new exports.psgeometry.AABB3D();
                    }
                };
            /**
        ...
        var OpaqueMeshBuilder = /** @class */ (function () {
             ...
             */
                function (x0, y0, z0, x1, y1, z1, r, g, b) {
                    /** @type {?} */
                    var dir = new exports.psgeometry.Vec3(x1, y1, z1).sub(new exports.psgeometry.Vec3(x0, y0, z0));
                    /** @type {?} */
                    var radius = dir.norm();
                    /** @type {?} */
                    ...
                    var thickness = .01;
                    /** @type {?} */
                    var up = ( /** @type {?} */(exports.psgeometry.Matrix4.FromRotation(azimuth, polar, 0).multiply(new exports.psgeometry.Vec4(0, thickness, 0, 1))));
                    /** @type {?} */
                    var front = ( /** @type {?} */(exports.psgeometry.Matrix4.FromRotation(azimuth, polar, 0).multiply(new exports.psgeometry.Vec4(0, 0, thickness, 1))));
             ...
             */
                function (ray, candidates) {
                    if (this.testIntersection) {
                        /** @type {?} */
                        var at = new exports.psgeometry.Vec3();
        ...
        var Camera = /** @class */ (function () {
             ...
             */
                function (eye, center, up) {
                    ...
                    var y = z.cross(x).normalize();
                    /** @type {?} */
                    var m = new exports.psgeometry.Matrix4([x.x, x.y, x.z, 0,
                        y.x, y.y, y.z, 0,
                        z.x, z.y, z.z, 0,
                        0, 0, 0, 1]);
                    /** @type {?} */
                    var t = new exports.psgeometry.Matrix4([1, 0, 0, -eye.x,
                        0, 1, 0, -eye.y,
                        0, 0, 1, -eye.z,
                        0, 0, 0, 1]);
                    return ( /** @type {?} */(t.multiply(m)));
             ...
             */
                function (left, right, bottom, top, near, far) {
                    return new exports.psgeometry.Matrix4([
                        2 / (right - left), 0, 0, 0,
                        0, 2 / (top - bottom), 0, 0,
                        0, 0, 2 / (near - far), 0,
        ...
        var ShadowCameraWebGL = /** @class */ (function (_super) {
             ...
             */
                function (stage) {
                    ...
                    this.update(new exports.psgeometry.Vec3(0, 10, 0), new exports.psgeometry.Vec3(0, 0, 0), new exports.psgeometry.Vec3(0, 0, -1));
             ...
             */
                function (bbox) {
                    ...
                    this.update(new exports.psgeometry.Vec3(center.x, 10, center.y), new exports.psgeometry.Vec3(center.x, 0, center.y), new exports.psgeometry.Vec3(0, 0, -1));
                    this.setDirty();
                };
            /**
             * @param {?} pos
        ...
        var CameraWebGL = /** @class */ (function (_super) {
             ...
             */
                function (clientX, clientY) {
                    /** @type {?} */
                    var cursor = new exports.psgeometry.Vec4(clientX / this.clientWidth * 2.0 - 1.0, 1.0 - clientY / this.clientHeight * 2.0, -1.0, 1.0);
                    /** @type {?} */
                    var direction = ( /** @type {?} */(this.inverseProjectionMatrix.multiply(cursor)));
                    direction.w = 1.0;
                    /** @type {?} */
                    var forward = this.inverseViewMatrix.multiply(direction);
                    return new exports.psgeometry.Line3D(this.currentCameraPos, forward);
                };
            return CameraWebGL;
        }(Camera));
        ...
        var TexturedMeshShaderProgramWebGL = /** @class */ (function (_super) {
            ...
            function TexturedMeshShaderProgramWebGL(variant) {
                if (variant === void 0) {
                    variant = TexturedMeshShaderProgramVariants.Diffuse;
                }
                ...
                function (context, shaderInstance) {
                    ...
                    if (bufferKey) {
                        ...
                        if (textureAsset) {
                            textureAsset.bind(stage, this, 'uTexture0');
                            /** @type {?} */
                            var color = context.State.get('Color', exports.psgeometry.Vec4.One);
                            /** @type {?} */
        ...
        var RenderStateStack = /** @class */ (function () {
            function RenderStateStack() {
                this.modelTransform = [exports.psgeometry.Matrix4.Identity];
                this.stack = [];
            }
             ...
             */
                function (state) {
                    ...
                    if (state.contains('ModelTransform')) {
                        /** @type {?} */
                        var modelTransform = state.get('ModelTransform', exports.psgeometry.Matrix4.Identity);
        ...
        var StageWebGL = /** @class */ (function () {
             ...
             */
                function (context) {
                    ...
                    /** @type {?} */
                    var resultingModelTransformation = exports.psgeometry.Matrix4.Identity;
        ...
        var InterfaceController = /** @class */ (function () {
             ...
             */
                function (target) {
                    var _this = this;
                    this.target = target;
                    JQuery__default(target).on('mousewheel', function (e) {
                        _this.mouseWheel(e);
                    });
                    JQuery__default(target).on('mousedown touchstart', function (e) {
                        _this.mouseDown(e);
                        e.preventDefault();
                    });
                    if (!(( /** @type {?} */(target))).setCapture) {
                        JQuery__default(document).on('mousemove touchmove', function (e) {
                            _this.mouseMove(e);
                        });
                    }
                    else {
                        JQuery__default(target).on('mousemove touchmove', function (e) {
                            _this.mouseMove(e);
                        });
                    }
                    JQuery__default(document).on('mouseup touchend touchcancel', function (e) {
                        _this.mouseUp(e);
                        e.preventDefault();
                    });
                    JQuery__default(target).on('losecapture', function (e) {
                        _this.mouseUp(e);
                        e.preventDefault();
                    });
                    JQuery__default(document).on('keyup', function (e) {
                        if (_this.keyUp(e)) {
                            e.preventDefault();
                        }
                    });
        ...
        var CameraController = /** @class */ (function () {
            function CameraController(stage, camera, interfaceController, connection) {
                ...
                interfaceController.bindEvents(JQuery__default(stage.Canvas));
                ...
                this.center = new exports.psgeometry.Vec3(0.0, 0.0, 0.0);
                this.updateCamera();
            }
             ...
             */
                function () {
                    ...
                    /** @type {?} */
                    var v;
                    v = new exports.psgeometry.Vec3(-1.0, 0.0, 0.0);
                    q = new exports.psgeometry.Quaternion();
                    r = new exports.psgeometry.Quaternion();
                    q.setFromAxisAngle(new exports.psgeometry.Vec3(0.0, 1.0, 0.0), this.yaw);
                    r.setFromAxisAngle(new exports.psgeometry.Vec3(1.0, 0.0, 0.0), this.pitch);
             ...
             */
                function () {
                    ...
                    /** @type {?} */
                    var v;
                    v = new exports.psgeometry.Vec3(0.0, 1.0, 0.0);
                    q = new exports.psgeometry.Quaternion();
                    r = new exports.psgeometry.Quaternion();
                    q.setFromAxisAngle(new exports.psgeometry.Vec3(0.0, 1.0, 0.0), this.yaw);
                    r.setFromAxisAngle(new exports.psgeometry.Vec3(1.0, 0.0, 0.0), this.pitch);
             ...
             */
                function () {
                    ...
                    /** @type {?} */
                    var v;
                    v = new exports.psgeometry.Vec3(0.0, 0.0, -1.0);
                    q = new exports.psgeometry.Quaternion();
                    r = new exports.psgeometry.Quaternion();
                    q.setFromAxisAngle(new exports.psgeometry.Vec3(0.0, 1.0, 0.0), this.yaw);
                    r.setFromAxisAngle(new exports.psgeometry.Vec3(1.0, 0.0, 0.0), this.pitch);
             ...
             */
                function () {
                    ...
                    /** @type {?} */
                    var v;
                    v = new exports.psgeometry.Vec3(0.0, 0.0, this.radius);
                    q = new exports.psgeometry.Quaternion();
                    r = new exports.psgeometry.Quaternion();
                    q.setFromAxisAngle(new exports.psgeometry.Vec3(0.0, 1.0, 0.0), this.yaw);
                    r.setFromAxisAngle(new exports.psgeometry.Vec3(1.0, 0.0, 0.0), this.pitch);
             ...
             */
                function () {
                    this.camera.update(this.getCameraPos(), this.center, new exports.psgeometry.Vec3(0.0, 1.0, 0.0));
                };
    ...
    })(exports.modelstageweb || (exports.modelstageweb = {}));
    ...
    (function (modelstageappstate) {
             ...
             */
                function () {
                    ...
                    if (this.assureRemainingBytes(12)) {
                        ...
                        result = new exports.psgeometry.Vec3(view.getFloat32(0, true), view.getFloat32(4, true), view.getFloat32(8, true));
                    }
                    else {
                        this.error = true;
                    }
             ...
             */
                function () {
                    ...
                    if (this.assureRemainingBytes(16)) {
                        ...
                        result = new exports.psgeometry.Vec4(view.getFloat32(0, true), view.getFloat32(4, true), view.getFloat32(8, true), view.getFloat32(12, true));
                    }
                    else {
                        this.error = true;
                    }
             ...
             */
                function (reader) {
                    ...
                    if (reader.Reader.assureRemainingBytes(4 * 4)) {
                        result = new exports.psgeometry.Vec4();
         ...
         */ AppStateCollection = /** @class */ (function (_super) {
            ...
            function AppStateCollection(appStateCollectionOperationType, serializeOperationChangedAt, serializePreviousValues) {
                if (serializeOperationChangedAt === void 0) {
                    serializeOperationChangedAt = true;
                }
                if (serializePreviousValues === void 0) {
                    serializePreviousValues = true;
                }
                var _this = _super.call(this) || this;
        ...
        var Director = /** @class */ (function () {
             ...
             */
                function (connection) {
                    ...
                    /** @type {?} */
                    var msg = exports.modelstageweb.NetworkChannelMessage.FromBuffer(buf);
        ...
        var DirectedSceneWebGL = /** @class */ (function (_super) {
             ...
             */
                function (message) {
                    if (message.MessageType == exports.modelstageweb.CommonMessageTypes.AppStateDelta || message.MessageType == exports.modelstageweb.CommonMessageTypes.AppStateInitialization) {
        ...
        }(exports.modelstageweb.SceneWebGL));
        modelstageappstate.DirectedSceneWebGL = DirectedSceneWebGL;
    })(exports.modelstageappstate || (exports.modelstageappstate = {}));
    ...
    (function (modelstage) {
        ...
        var SpaceModel = /** @class */ (function () {
             ...
             */
                function (transparentMeshBuilder, texturedMeshBuilder) {
                    ...
                    var toggle = false;
                    /** @type {?} */
                    var poly = new exports.psgeometry.Polygon2D();
                    for (var i = 0; i < this.vertices.length; i++) {
                        poly.addVector(this.vertices[i]);
                    }
                    /** @type {?} */
                    var bbox = new exports.psgeometry.AABB2D();
                    poly.addToAABB(bbox);
                    /** @type {?} */
                    var extents = bbox.extents();
             ...
             */
                function () {
                    /** @type {?} */
                    var spaceIndices = new exports.modelstageweb.BufferAssetWebGL(undefined, 'space_indices', true);
                    /** @type {?} */
                    var spaceVertices = new exports.modelstageweb.BufferAssetWebGL(undefined, 'space_vertices', false);
                    /** @type {?} */
                    var transparentMeshBuilder = new exports.modelstageweb.TransparentMeshBuilder(spaceVertices, spaceIndices);
                    /** @type {?} */
                    var floorIndices = new exports.modelstageweb.BufferAssetWebGL(undefined, 'floor_indices', true);
                    /** @type {?} */
                    var floorVertices = new exports.modelstageweb.BufferAssetWebGL(undefined, 'floor_vertices', false);
                    /** @type {?} */
                    var texturedMeshBuilder = new exports.modelstageweb.TexturedMeshBuilder(floorVertices, floorIndices);
                    ...
                    /** @type {?} */
                    var figure = new exports.modelstageweb.FigureWebGL('Space');
                    ...
                    /** @type {?} */
                    var floorShaderInstance = new exports.modelstageweb.MeshShaderInstance('TexturedMeshShader');
                    ...
                    /** @type {?} */
                    var shaderInstance = new exports.modelstageweb.MeshShaderInstance('TransparentMeshShader');
                    ...
                    this.actor.Filter = new exports.modelstageweb.GenericSceneItemFilterWebGL();
             ...
             */
                function (x, y) {
                    this.vertices.push(new exports.psgeometry.Vec2(x, y));
                };
            return SpaceModel;
        }());
        ...
        var TheaterWebGL = /** @class */ (function () {
            function TheaterWebGL(canvasElementID) {
                var _this = this;
                this.stage = new exports.modelstageweb.StageWebGL(canvasElementID);
        ...
        var ActorManipulationTool = /** @class */ (function (_super) {
             ...
             */
                function (actor) {
                    /** @type {?} */
                    var translationVec = actor.Data['translate'] || exports.psgeometry.Vec4.Zero;
                    /** @type {?} */
                    var rotationVec = actor.Data['rotate'] || exports.psgeometry.Vec4.Zero;
                    ...
                    /** @type {?} */
                    var translation = exports.psgeometry.Matrix4.FromTranslation(translationVec.x, translationVec.y, translationVec.z);
                    /** @type {?} */
                    var rotation = exports.psgeometry.Matrix4.FromRotationY(rotationVec.y);
             ...
             */
                function (actor, x, y, z) {
                    actor.Data['translate'] = new exports.psgeometry.Vec4(x, y, z);
             ...
             */
                function (actor, x, y, z) {
                    actor.Data['rotate'] = new exports.psgeometry.Vec4(x, y, z);
                    this.updateModelTransform(actor);
                };
            return ActorManipulationTool;
        }(exports.modelstageweb.Tool));
             ...
             */
                function () {
                    ...
                    if (this.selectedActor) {
                        /** @type {?} */
                        var box_1 = new exports.psgeometry.AABB3D;
                        this.selectedActor.Figures.forEach(function (fig) {
                            box_1.addAABB(fig.getBoundingBox());
                        });
                        /** @type {?} */
                        var bottomCenterPoint = new exports.psgeometry.Vec3(box_1.center().x, box_1.minY, box_1.center().z);
                        /** @type {?} */
                        var selectionMarker = new exports.modelstageweb.ActorWebGL(this.scene, SelectionTool.SelectionObjectID);
                        var _b = __read([.16, .34, .6], 3), r = _b[0], g = _b[1], b = _b[2];
                        /** @type {?} */
                        var meshBuilder = new exports.modelstageweb.OpaqueMeshBuilder();
                        // top lid
                        ...
                        /** @type {?} */
                        var figureBoundingBox = new exports.psgeometry.AABB3D();
                        _a = __read([.6, .1, .1], 3), r = _a[0], g = _a[1], b = _a[2];
                        /** @type {?} */
                        var meshBuilder1 = new exports.modelstageweb.OpaqueMeshBuilder();
                        /** @type {?} */
                        var segmentCount = 24;
                        /** @type {?} */
                        var radius0 = 1;
                        ...
                        for (var i = 0; i < segmentCount; ++i) {
                            ...
                            /** @type {?} */
                            var inner0 = new exports.psgeometry.Vec3(Math.sin(angle0) * radius0, 0, Math.cos(angle0) * radius0).add(bottomCenterPoint);
                            /** @type {?} */
                            var inner1 = new exports.psgeometry.Vec3(Math.sin(angle1) * radius0, 0, Math.cos(angle1) * radius0).add(bottomCenterPoint);
                            /** @type {?} */
                            var outer0 = new exports.psgeometry.Vec3(Math.sin(angle0) * radius1, 0, Math.cos(angle0) * radius1).add(bottomCenterPoint);
                            /** @type {?} */
                            var outer1 = new exports.psgeometry.Vec3(Math.sin(angle1) * radius1, 0, Math.cos(angle1) * radius1).add(bottomCenterPoint);
                        ...
                        figure.setIntersector(new exports.modelstageweb.BoundingBoxIntersector(figureBoundingBox));
                        selectionMarker.addFigure(figure);
                        /** @type {?} */
                        var sceneObjTranslation = this.scene.State.get('SceneObjectPos' + this.selectedActor.Data['SceneObjID'], exports.psgeometry.Vec4.Zero);
                        /** @type {?} */
                        var sceneObjRotation = this.scene.State.get('SceneObjectRot' + this.selectedActor.Data['SceneObjID'], exports.psgeometry.Vec4.Zero);
                        selectionMarker.State.set('ModelTransform', exports.psgeometry.Matrix4.FromRotation(sceneObjRotation.x, sceneObjRotation.y, sceneObjRotation.z).multiply(exports.psgeometry.Matrix4.FromTranslation(sceneObjTranslation.x, sceneObjTranslation.y, sceneObjTranslation.z)));
                        selectionMarker.Filter = new exports.modelstageweb.GenericSceneItemFilterWebGL();
             ...
             */
                function (e) {
                    ...
                    while (!pickedObject && currentIdx < candidates.length) {
                        if (candidates[currentIdx].sceneItem instanceof exports.modelstageweb.ActorWebGL) {
                            /** @type {?} */
        ...
        var PlaceActorTool = /** @class */ (function (_super) {
            ...
            function PlaceActorTool(figureID, camera, connection) {
                ...
                _this.sceneObj.SceneObjectID = exports.modelstageweb.uuidv4();
                _this.sceneObj.Location = new exports.psgeometry.Vec4();
                _this.sceneObj.Rotation = new exports.psgeometry.Vec4();
                _this.sceneObj.Scale = new exports.psgeometry.Vec4(1, 1, 1, 1);
             ...
             */
                function (e, x, y) {
                    ...
                    /** @type {?} */
                    var p = viewRay.intersectRayWithPlane(new exports.psgeometry.Vec3(), new exports.psgeometry.Vec3(0, 1, 0));
                    if (p) {
                        this.sceneObj = __assign({}, this.sceneObj);
                        this.sceneObj.Location = new exports.psgeometry.Vec4(p.x, 0, p.z);
                    ...
                    if (p) {
                        if (this.isInitialized) {
                            ...
                            if (sceneObj) {
                                ...
                                translatedSceneObj.Location = translatedSceneObj.Location.add(new exports.psgeometry.Vec4(p.x - this.lastX, 0, p.z - this.lastZ));
             ...
             */
                function (e, startX, startY, dX, dY) {
                    ...
                    if (sceneObj) {
                        ...
                        rotatedSceneObj.Rotation = rotatedSceneObj.Rotation.add(new exports.psgeometry.Vec4(dX / (fac * 100) * Math.PI, 0, 0));
        ...
        var DemoSceneWebGL = /** @class */ (function (_super) {
            ...
            function DemoSceneWebGL(stage, connection) {
                var _this = _super.call(this, new exports.modelstageappstate.Director(exports.modelstageappstate.AppState.GetInstance()), connection) || this;
                _this.spaceActor = new exports.modelstageweb.ActorWebGL(_this, 'Space');
                _this.director.Scene = _this;
                _this.stage = stage;
                _this.spaceModel = new SpaceModel(_this, _this.stage, _this.spaceActor);
                /** @type {?} */
                var shaderProgram = new exports.modelstageweb.OpaqueMeshShaderProgramWebGL();
                shaderProgram.initialize(stage);
                stage.registerShaderProgram('OpaqueMeshShader', shaderProgram);
                shaderProgram = new exports.modelstageweb.TransparentMeshShaderProgramWebGL();
                shaderProgram.initialize(stage);
                stage.registerShaderProgram('TransparentMeshShader', shaderProgram);
                shaderProgram = new exports.modelstageweb.TexturedMeshShaderProgramWebGL();
                shaderProgram.initialize(stage);
                stage.registerShaderProgram('TexturedMeshShader', shaderProgram);
                shaderProgram = new exports.modelstageweb.MatCapShaderProgramWebGL();
                shaderProgram.initialize(stage);
                stage.registerShaderProgram('MatCapMeshShader', shaderProgram);
                // Shadow shaders
                shaderProgram = new exports.modelstageweb.ShadowTexturedMeshShaderProgramWebGL();
                shaderProgram.initialize(stage);
             ...
             */
                function (peerID, peerColorIndex, userName) {
                    if (peerID != '-1') {
                        ...
                        /** @type {?} */
                        var peerInfoElement = JQuery__default('#' + peerInfoID);
                        if (peerInfoElement.length > 0) {
                            peerInfoElement.find('span').text(userName);
                        }
                        else {
                            JQuery__default('#participants-view').append('<li id="' + peerInfoID + '"><img src="images/info/Lens' + peerColorIndex + '.png" /><span>' + userName + '</span></li>');
                        }
                    }
                };
            /**
             ...
             */
                function (peerID) {
                    /** @type {?} */
                    var obj = new exports.modelstageweb.ActorWebGL(this, 'Peer' + peerID);
                    ...
                    obj.State.set('Color', new exports.psgeometry.Vec4(PeerColors[colorIndex][0], PeerColors[colorIndex][1], PeerColors[colorIndex][2], PeerColors[colorIndex][3]));
                    obj.State.set('ModelTransform', function (state) {
                        /** @type {?} */
                        var pos = state.get('HeadPos' + peerID, exports.psgeometry.Vec4.Zero);
                        /** @type {?} */
                        var cursor = state.get('CursPos' + peerID, exports.psgeometry.Vec4.Zero);
                        /** @type {?} */
                        var dir = cursor.sub(pos);
                        /** @type {?} */
                        var spherical = exports.psgeometry.Spherical.FromCartesianVector(dir);
                        return (( /** @type {?} */(exports.psgeometry.Matrix4.FromRotationX(-spherical.azimuth).multiply(exports.psgeometry.Matrix4.FromRotationY(-spherical.polar))))).multiply(exports.psgeometry.Matrix4.FromTranslation(pos.x, pos.y, pos.z));
                    });
             ...
             */
                function (objectID, assetID) {
                    ...
                    var suffix = objectID;
                    /** @type {?} */
                    var obj = new exports.modelstageweb.ActorWebGL(this, 'SceneObject' + suffix);
                    obj.State.set('ModelTransform', function (state) {
                        /** @type {?} */
                        var pos = state.get('SceneObjectPos' + suffix, exports.psgeometry.Vec4.Zero);
                        /** @type {?} */
                        var rot = state.get('SceneObjectRot' + suffix, exports.psgeometry.Vec4.Zero);
                        /** @type {?} */
                        var scale = state.get('SceneObjectScale' + suffix, exports.psgeometry.Vec4.One);
                        return ( /** @type {?} */(exports.psgeometry.Matrix4.FromRotation(rot.x, rot.y, rot.z).multiply(exports.psgeometry.Matrix4.FromScaling(scale.x, scale.y, scale.z).multiply(exports.psgeometry.Matrix4.FromTranslation(pos.x, pos.y, pos.z)))));
                    });
        ...
        }(exports.modelstageappstate.DirectedSceneWebGL));
        ...
        var RoomAppState = /** @class */ (function (_super) {
            ...
            function RoomAppState() {
                var _this = _super.call(this) || this;
                _this.FloorLevel = new exports.modelstageappstate.AppStateFloatValue();
                _this.MasterView = new exports.modelstageappstate.AppStateVector4Value();
                _this.Vertices = new exports.modelstageappstate.AppStateCollection(exports.modelstageappstate.AppStateCollectionOperation);
            ...
            return RoomAppState;
        }(exports.modelstageappstate.AppStateCluster));
        ...
        var SceneAppState = /** @class */ (function (_super) {
            ...
            function SceneAppState() {
                var _this = _super.call(this) || this;
                _this.SceneObjects = new exports.modelstageappstate.AppStateCollection(exports.modelstageappstate.AppStateCollectionOperation);
             ...
             */
                function (key, writer, value) {
                    if (key == 'Obj') {
                        ...
                        writer.Writer.writeVec4(exports.psgeometry.Vec4.One);
                    }
                    else {
                ...
                function (scene, peerID, instanceID) {
                    if (this.SceneObjects.isDirty()) {
                        ...
                        this.SceneObjects.Operations.forEach(function (operation) {
                            if (operation.Operation == exports.modelstageappstate.OperationType.Append) {
                                /** @type {?} */
                            ...
                            else if (operation.Operation == exports.modelstageappstate.OperationType.Replace) {
                                /** @type {?} */
                                var objID = operation.NewValue.SceneObjectID;
                                scene.State.set('SceneObjectPos' + objID, operation.NewValue.Location);
                                scene.State.set('SceneObjectRot' + objID, operation.NewValue.Rotation);
                            ...
                            else if (operation.Operation == exports.modelstageappstate.OperationType.Remove) {
                                /** @type {?} */
        ...
        var PeerAppState = /** @class */ (function (_super) {
            ...
            function PeerAppState() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.headPos = new exports.modelstageappstate.AppStateVector4Value();
                _this.cursorPos = new exports.modelstageappstate.AppStateVector4Value();
                _this.userID = new exports.modelstageappstate.AppStateStringValue();
                _this.active = new exports.modelstageappstate.AppStateBoolValue();
                return _this;
            }
            /**
             * @return {?}
             ...
             */
                function (scene, peerID, instanceID) {
                    ...
                    if (peerID.length > 0 && (this.headPos.isDirty() || this.cursorPos.isDirty())) {
                        ...
                        /** @type {?} */
                        var levelOfs = new exports.psgeometry.Vec4(0, -sc.SpaceModel.FloorLevel, 0, 0);
                        /** @type {?} */
        ...
        var NotesAppState = /** @class */ (function (_super) {
            ...
            function NotesAppState() {
                var _this = _super.call(this) || this;
                _this.Notes = new exports.modelstageappstate.AppStateCollection(exports.modelstageappstate.AppStateCollectionOperation);
    ...
    var SampleTheaterWebGL = /** @class */ (function (_super) {
        ...
        function SampleTheaterWebGL(canvasElementID) {
            ...
            _this.peerAppState = new exports.modelstageappstate.LocalAppStateClusterManager(exports.ɵa.PeerAppState.ClusterTypeID, exports.ɵa.PeerAppState);
            _this.sceneAppState = new exports.modelstageappstate.GlobalAppStateClusterManager(exports.ɵa.SceneAppState.ClusterTypeID, exports.ɵa.SceneAppState);
            _this.roomAppState = new exports.modelstageappstate.GlobalAppStateClusterManager(exports.ɵa.RoomAppState.ClusterTypeID, exports.ɵa.RoomAppState);
            _this.notesAppState = new exports.modelstageappstate.GlobalAppStateClusterManager(exports.ɵa.NotesAppState.ClusterTypeID, exports.ɵa.NotesAppState);
            _this.actorIndex = 1;
            _this.channels = {};
            _this.connection = new exports.modelstageweb.SignalRServerConnection();
            _this.scene = new exports.ɵa.DemoSceneWebGL(_this.stage, _this.connection);
            ...
            _this.connection.onMessage(function (msg) {
                if (msg.data instanceof ArrayBuffer || msg.data instanceof Uint8Array) {
                    ...
                    /** @type {?} */
                    var networkMessage = exports.modelstageweb.NetworkChannelMessage.FromBuffer(buf);
            ...
            _this.interfaceController = new exports.modelstageweb.InterfaceController();
            _this.cameraController = new exports.modelstageweb.CameraController(_this.Stage, _this.Stage.Camera, _this.interfaceController, _this.connection);
            _this.cameraController.construct(12.0, -0.45, 0.0);
            _this.interfaceController.pushTool(new exports.ɵa.SelectionTool(_this.scene, _this.stage, _this.connection));
            JQuery.$(function () {
                _this.connection.connect();
                (( /** @type {?} */(JQuery.$('.area-right-sidebar ul li')))).draggable({
                ...
                (( /** @type {?} */(JQuery.$('#viewCanvas')))).droppable({
                /*   over: (event, ui) => {
    ...
    exports.modelstage = exports.ɵa;
    exports.MessageChannel = MessageChannel;
    exports.SampleTheaterWebGL = SampleTheaterWebGL;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-modelstage.umd.js.map